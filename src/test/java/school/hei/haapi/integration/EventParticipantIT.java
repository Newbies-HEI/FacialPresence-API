...
class EventParticipantIT {
    ...
    public static school.hei.haapi.endpoint.rest.model.EventParticipant eventParticipant1() {
        ...
        eventParticipant.setParticipant(new User());
    ...
    void student_read_ko() {
        ...
        PlacesApi api = new PlacesApi(eventParticipant1Client);

        assertThrowsForbiddenException(
                () -> api.getEventParticipants("event1_id", 1, 10));
    }
    ...
    void teacher_read_ok() throws ApiException {
        ...
        List<school.hei.haapi.endpoint.rest.model.EventParticipant> actualEventParticipants = api.getEventParticipants("event1_id", 1, 10);
    ...
    void student_write_ko() {
        ...
        assertThrowsForbiddenException(() -> api.createOrUpdateEventParticipants(List.of()));
    }
    ...
    void manager_write_update_ok() throws ApiException {
        ...
        List<school.hei.haapi.endpoint.rest.model.EventParticipant> toUpdate =
                api.createOrUpdateEventParticipants(List.of(someCreatableEventParticipant(), someCreatableEventParticipant()));
        ...
        List<school.hei.haapi.endpoint.rest.model.EventParticipant> updated = api.createOrUpdateEventParticipants(toUpdate);
